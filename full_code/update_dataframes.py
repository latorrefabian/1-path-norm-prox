...
def write_model_data(ckpt_dir, df_file, delete_missing=False):
    ...
    for f in tqdm(remaining_files):
        ...
        params['file'] = f_wo_ext
        params['nnz'] = nonzero_params_percentage(network)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            '--ckpt_dir', type=str, default='ckpts', help=help_['ckpt_dir'])
    parser.add_argument(
            '--data_dir', type=str, default='data', help=help_['data_dir'])
    parser.add_argument(
            '--errors_dir', type=str, default='errors',
