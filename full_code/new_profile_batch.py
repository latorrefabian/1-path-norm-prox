...
from defaults import new_var_dict as var_dict
from defaults import INTERPRETER
from defaults import NEW_CKPT_DIR as CKPT_DIR
from defaults import NEW_DATA_DIR as DATA_DIR
...
def main(vars_, script_dir, overwrite, **args):
    script = os.path.join(script_dir, 'new_profile.py')
...
if __name__ == '__main__':
    ...
    # SLURM parameters
    parser.add_argument('--job_name', type=str, default='new_robsparse')
